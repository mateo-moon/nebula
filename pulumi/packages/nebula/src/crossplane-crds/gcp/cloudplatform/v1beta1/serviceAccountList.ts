...
export class ServiceAccountList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cloudplatform.gcp.upbound.io/v1beta1:ServiceAccountList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cloudplatform.v1beta1.ServiceAccount[]>;
    /**
...
export interface ServiceAccountListArgs {
     ...
     * List of serviceaccounts. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
     */
    items: pulumi.Input<pulumi.Input<inputs.cloudplatform.v1beta1.ServiceAccount>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
