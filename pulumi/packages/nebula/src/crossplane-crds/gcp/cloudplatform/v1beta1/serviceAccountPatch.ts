...
export class ServiceAccountPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cloudplatform.gcp.upbound.io/v1beta1:ServiceAccountPatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.cloudplatform.v1beta1.ServiceAccountSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cloudplatform.v1beta1.ServiceAccountStatusPatch>;
...
export interface ServiceAccountPatchArgs {
    ...
    spec?: pulumi.Input<inputs.cloudplatform.v1beta1.ServiceAccountSpecPatch>;
}
