...
export class HMACKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.gcp.upbound.io/v1beta1:HMACKey';
    ...
    declare public readonly spec: pulumi.Output<outputs.storage.v1beta1.HMACKeySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.storage.v1beta1.HMACKeyStatus>;
...
export interface HMACKeyArgs {
    ...
    spec?: pulumi.Input<inputs.storage.v1beta1.HMACKeySpec>;
}
