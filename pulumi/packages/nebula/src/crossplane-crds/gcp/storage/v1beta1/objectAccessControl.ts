...
export class ObjectAccessControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.gcp.upbound.io/v1beta1:ObjectAccessControl';
    ...
    declare public readonly spec: pulumi.Output<outputs.storage.v1beta1.ObjectAccessControlSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.storage.v1beta1.ObjectAccessControlStatus>;
...
export interface ObjectAccessControlArgs {
    ...
    spec?: pulumi.Input<inputs.storage.v1beta1.ObjectAccessControlSpec>;
}
