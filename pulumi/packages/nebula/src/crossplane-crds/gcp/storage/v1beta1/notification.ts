...
export class Notification extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.gcp.upbound.io/v1beta1:Notification';
    ...
    declare public readonly spec: pulumi.Output<outputs.storage.v1beta1.NotificationSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.storage.v1beta1.NotificationStatus>;
...
export interface NotificationArgs {
    ...
    spec?: pulumi.Input<inputs.storage.v1beta1.NotificationSpec>;
}
