...
export class DefaultObjectACL extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DefaultObjectACL {
        return new DefaultObjectACL(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.gcp.upbound.io/v1beta1:DefaultObjectACL';
    ...
    declare public readonly spec: pulumi.Output<outputs.storage.v1beta1.DefaultObjectACLSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.storage.v1beta1.DefaultObjectACLStatus>;
...
export interface DefaultObjectACLArgs {
    ...
    spec?: pulumi.Input<inputs.storage.v1beta1.DefaultObjectACLSpec>;
}
