...
export class BucketIAMMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:storage.gcp.upbound.io/v1beta2:BucketIAMMember';
    ...
    declare public readonly spec: pulumi.Output<outputs.storage.v1beta2.BucketIAMMemberSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.storage.v1beta2.BucketIAMMemberStatus>;
    ...
    constructor(name: string, args?: BucketIAMMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:storage.gcp.upbound.io/v1beta1:BucketIAMMember" }] };
...
export interface BucketIAMMemberArgs {
    ...
    spec?: pulumi.Input<inputs.storage.v1beta2.BucketIAMMemberSpec>;
}
