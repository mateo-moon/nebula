...
export class ClusterList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cluster.argocd.crossplane.io/v1alpha1:ClusterList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cluster.v1alpha1.Cluster[]>;
    /**
...
export interface ClusterListArgs {
     ...
     * List of clusters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
     */
    items: pulumi.Input<pulumi.Input<inputs.cluster.v1alpha1.Cluster>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
