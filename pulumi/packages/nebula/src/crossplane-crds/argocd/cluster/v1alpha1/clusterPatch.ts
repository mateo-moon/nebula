...
export class ClusterPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cluster.argocd.crossplane.io/v1alpha1:ClusterPatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.cluster.v1alpha1.ClusterSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cluster.v1alpha1.ClusterStatusPatch>;
...
export interface ClusterPatchArgs {
    ...
    spec?: pulumi.Input<inputs.cluster.v1alpha1.ClusterSpecPatch>;
}
