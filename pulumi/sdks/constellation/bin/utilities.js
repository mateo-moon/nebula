...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setName("constellation");
            params.setVersion("2.24.0");
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2VkZ2VsZXNzc3lzL2NvbnN0ZWxsYXRpb24iLCJ2ZXJzaW9uIjoiMi4yNC4wIn19"), c => c.charCodeAt(0)));
