...
export interface ClusterSpecForProviderNodeConfig {
   ...
   *
   * @schema ClusterSpecForProviderNodeConfig#index
   */
...
export interface ClusterSpecInitProviderNodeConfig {
   ...
   * This is an injected field with a default value for being able to merge items of the parent object list.
   *
   * @schema ClusterSpecInitProviderNodeConfig#index
   */
  readonly index?: string;
...
export interface ClusterSpecForProviderMonitoringConfigAdvancedDatapathObservabilityConfig {
   ...
   *
   * @schema ClusterSpecForProviderMonitoringConfigAdvancedDatapathObservabilityConfig#relayMode
   */
...
export interface ClusterSpecInitProviderMonitoringConfigAdvancedDatapathObservabilityConfig {
   ...
   * Mode used to make Relay available.
   *
   * @schema ClusterSpecInitProviderMonitoringConfigAdvancedDatapathObservabilityConfig#relayMode
   */
  readonly relayMode?: string;
}
...
export interface ClusterV1Beta2Spec {
   ...
   * and password required to connect to the managed resource.
   *
   * @schema ClusterV1Beta2Spec#publishConnectionDetailsTo
   */
  readonly publishConnectionDetailsTo?: ClusterV1Beta2SpecPublishConnectionDetailsTo;
...
export function toJson_ClusterV1Beta2Spec(obj: ClusterV1Beta2Spec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'publishConnectionDetailsTo': toJson_ClusterV1Beta2SpecPublishConnectionDetailsTo(obj.publishConnectionDetailsTo),
 ...
 * and password required to connect to the managed resource.
 *
 * @schema ClusterV1Beta2SpecPublishConnectionDetailsTo
 */
export interface ClusterV1Beta2SpecPublishConnectionDetailsTo {
  /**
   * SecretStoreConfigRef specifies which secret store config should be used
   * for this ConnectionSecret.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsTo#configRef
   */
  readonly configRef?: ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef;

  /**
   * Metadata is the metadata for connection secret.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsTo#metadata
   */
  readonly metadata?: ClusterV1Beta2SpecPublishConnectionDetailsToMetadata;

  /**
   * Name is the name of the connection secret.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsTo#name
   */
  readonly name: string;
}

/**
 * Converts an object of type 'ClusterV1Beta2SpecPublishConnectionDetailsTo' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ClusterV1Beta2SpecPublishConnectionDetailsTo(obj: ClusterV1Beta2SpecPublishConnectionDetailsTo | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'configRef': toJson_ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef(obj.configRef),
    'metadata': toJson_ClusterV1Beta2SpecPublishConnectionDetailsToMetadata(obj.metadata),
    'name': obj.name,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * for this ConnectionSecret.
 *
 * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef
 */
export interface ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef {
  /**
   * Name of the referenced object.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef#name
   */
  readonly name: string;
   ...
   * Policies for referencing.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef#policy
   */
  readonly policy?: ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy;
}

/**
 * Converts an object of type 'ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef(obj: ClusterV1Beta2SpecPublishConnectionDetailsToConfigRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Metadata is the metadata for connection secret.
 *
 * @schema ClusterV1Beta2SpecPublishConnectionDetailsToMetadata
 */
export interface ClusterV1Beta2SpecPublishConnectionDetailsToMetadata {
  /**
   * Annotations are the annotations to be added to connection secret.
   * - For Kubernetes secrets, this will be used as "metadata.annotations".
   * - It is up to Secret Store implementation for others store types.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToMetadata#annotations
   */
  readonly annotations?: { [key: string]: string };
   ...
   * - It is up to Secret Store implementation for others store types.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToMetadata#labels
   */
  readonly labels?: { [key: string]: string };
   ...
   * - Only valid for Kubernetes Secret Stores.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToMetadata#type
   */
  readonly type?: string;
}

/**
 * Converts an object of type 'ClusterV1Beta2SpecPublishConnectionDetailsToMetadata' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ClusterV1Beta2SpecPublishConnectionDetailsToMetadata(obj: ClusterV1Beta2SpecPublishConnectionDetailsToMetadata | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'annotations': ((obj.annotations) === undefined) ? undefined : (Object.entries(obj.annotations).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'labels': ((obj.labels) === undefined) ? undefined : (Object.entries(obj.labels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
...
export interface ClusterV1Beta2SpecForProviderMonitoringConfigAdvancedDatapathObservabilityConfig {
   ...
   *
   * @schema ClusterV1Beta2SpecForProviderMonitoringConfigAdvancedDatapathObservabilityConfig#relayMode
   */
  readonly relayMode?: string;
}
...
export interface ClusterV1Beta2SpecInitProviderMonitoringConfigAdvancedDatapathObservabilityConfig {
   ...
   * Mode used to make Relay available. Deprecated in favor of enable_relay field. Remove this attribute's configuration as this field will be removed in the next major release and enable_relay will become a required field.
   *
   * @schema ClusterV1Beta2SpecInitProviderMonitoringConfigAdvancedDatapathObservabilityConfig#relayMode
   */
  readonly relayMode?: string;
}
 ...
 * Policies for referencing.
 *
 * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy
 */
export interface ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required.
   * The default is 'Required', which means the reconcile will fail if the
   * reference cannot be resolved. 'Optional' means this reference will be
   * a no-op if it cannot be resolved.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy#resolution
   */
  readonly resolution?: ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicyResolution;
   ...
   * reference on every reconcile.
   *
   * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy#resolve
   */
  readonly resolve?: ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicyResolve;
}

/**
 * Converts an object of type 'ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy(obj: ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * a no-op if it cannot be resolved.
 *
 * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicyResolution
 */
export enum ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * reference on every reconcile.
 *
 * @schema ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicyResolve
 */
export enum ClusterV1Beta2SpecPublishConnectionDetailsToConfigRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",
