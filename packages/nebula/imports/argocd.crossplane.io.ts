...
export interface ProviderConfigSpec {
   ...
   *
   * @schema ProviderConfigSpec#grpcWeb
   */
   ...
   *
   * @schema ProviderConfigSpec#grpcWebRootPath
   */
...
export function toJson_ProviderConfigSpec(obj: ProviderConfigSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'grpcWeb': obj.grpcWeb,
    'grpcWebRootPath': obj.grpcWebRootPath,
...
export interface ProviderConfigSpecCredentials {
   ...
   *
   * @schema ProviderConfigSpecCredentials#audiences
   */
   ...
   *
   * @schema ProviderConfigSpecCredentials#azureWorkloadIdentityOptions
   */
  readonly azureWorkloadIdentityOptions?: ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions;
...
export function toJson_ProviderConfigSpecCredentials(obj: ProviderConfigSpecCredentials | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'azureWorkloadIdentityOptions': toJson_ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions(obj.azureWorkloadIdentityOptions),
 ...
 * AzureWorkloadIdentityOptions contains optional parameters for AzureWorkloadIdentity.
 *
 * @schema ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions
 */
export interface ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions {
  /**
   * ClientID of the service principal. Defaults to the value of the environment variable AZURE_CLIENT_ID.
   *
   * @default the value of the environment variable AZURE_CLIENT_ID.
   * @schema ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions#clientID
   */
   ...
   *
   * @default the value of the environment variable AZURE_TENANT_ID.
   * @schema ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions#tenantID
   */
   ...
   * @schema ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions#tokenFilePath
   */
  readonly tokenFilePath?: string;
}

/**
 * Converts an object of type 'ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions(obj: ProviderConfigSpecCredentialsAzureWorkloadIdentityOptions | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'clientID': obj.clientId,
    'tenantID': obj.tenantId,
    'tokenFilePath': obj.tokenFilePath,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
